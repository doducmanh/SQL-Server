...
/****** Object:  StoredProcedure [dbo].[AD_PROMOTE]    Script Date: 06/02/2023 14:57:03 ******/
SET ANSI_NULLS ON
GO
...
, F1 AS (
	SELECT
		...
		CASE
			...
			WHEN F15.[AD_Grade] IN ('SZD', 'ASZD') AND F14.[AD_Grade] IN ('SZD', 'ASZD') THEN F12.FYPincTopup_6M * 0.5
...
, F3 AS (
	...
	AND App_ProDe_Date_NGUOIDCTUYEN >= DATEADD(month, -18, EOMONTH(@varREPORT_MONTH))
