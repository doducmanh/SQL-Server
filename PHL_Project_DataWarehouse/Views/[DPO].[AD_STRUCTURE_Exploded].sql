...
/****** Object:  View [DPO].[AD_STRUCTURE_Exploded]    Script Date: 30/09/2022 16:24:10 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [DPO].[AD_STRUCTURE_Exploded] AS
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[12] 4[1] 2[47] 3) )"
      End
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'DPO', @level1type=N'VIEW',@level1name=N'AD_STRUCTURE_Exploded'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'DPO', @level1type=N'VIEW',@level1name=N'AD_STRUCTURE_Exploded'
GO
