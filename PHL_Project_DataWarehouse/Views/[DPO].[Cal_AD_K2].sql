...
/****** Object:  View [DPO].[Cal_AD_K2]    Script Date: 30/09/2022 16:31:01 ******/
SET ANSI_NULLS ON
GO
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'DPO', @level1type=N'VIEW',@level1name=N'Cal_AD_K2'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'DPO', @level1type=N'VIEW',@level1name=N'Cal_AD_K2'
GO
